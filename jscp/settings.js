...
let settings = {
    ...
    sequence: 'HAPPY|BIRTHDAY|TO|YOU|MY DEAR|AATHIRA|❤',
    sequenceColor: '#ff69b4', // Pink color
    gift: '', // No sticker/GIF
    pages: [
        { image: './image/Birthday!/cover.jpg', content: '' }, // Front cover
        { image: './image/Birthday!/photo1.jpg', content: 'Dear Aathira, you bring so much joy and happiness! 💕' },
...
function initializeDefaultSettings() {
    ...
    window.settings = {
        music: './music/songforbday.mp3',
        countdown: 3,
        matrixText: 'HAPPYBIRTHDAY',
        matrixColor1: '#ff69b4', // Pink color
        matrixColor2: '#ff1493', // Pink color
        sequence: 'HAPPY|BIRTHDAY|TO|YOU|AATHIRA|❤',
        sequenceColor: '#ff69b4', // Pink color
        gift: '', // No sticker/GIF
        enableBook: true,
        enableHeart: true,
        ...
        pages: [
            { image: './image/Birthday!/cover.jpg', content: '' }, // Front cover
            { image: './image/Birthday!/photo1.jpg', content: 'Dear Aathira, you bring so much joy and happiness! 💕' },
            { image: './image/Birthday!/photo2.jpg', content: 'Your smile makes me happy so keep smiling! ✨' },
            { image: './image/Birthday!/photo3.jpg', content: 'You are such an amazing and beautiful person! 🌸' },
            { image: './image/Birthday!/photo4.jpg', content: 'dont feel sad i will always be here for you! 💖' },
            { image: './image/Birthday!/photo5.jpg', content: 'Wishing you the most wonderful birthday ever! 🎉' },
            { image: './image/Birthday!/photo6.jpg', content: 'May all your dreams come true! if not then i will make it possible ⭐' },
            { image: './image/Birthday!/photo7.jpg', content: 'You deserve all the happiness in the world maa! 💕' },
            { image: './image/Birthday!/photo8.jpg', content: 'Love you so much! Have the best day! ❤️🎂' },
